...
function generateOrderHash (bidOrAsk, orderType, baseCoin, targetCoin, amount, price, timeBeforeExpiration) {
    randomString = secureRandom.randomUint8Array(32).map(String).join('');
    concatString = [bidOrAsk, orderType, baseCoin, targetCoin, amount, price, timeBeforeExpiration, randomString].join('');
    return sha3(concatString);
}
...
module.exports = {
    ...
    isBloom: isBloom,
    isTopic: isTopic,
    generateOrderHash: generateOrderHash,
};
