...
var methods = function () {
    var getCrosschainDepositEntry = new Method ({
        name: 'getCrosschainDepositEntry',
        call: 'kanban_getCrosschainDepositEntry',
        params: 1
    });

    var getCrosschainWithdrawalEntry = new Method ({
        name: 'getCrosschainWithdrawalEntry',
        call: 'kanban_getCrosschainWithdrawalEntry',
        params: 1
    });

    var getCrosschainWithdrawInfo = new Method ({
        name: 'getCrosschainWithdrawInfo',
        call: 'kanban_getCrosschainWithdrawInfo',
        params: 0
    });

    var getTokenList = new Method ({
        name: 'getTokenList',
        call: 'kanban_getTokenList',
        params: 0
    });

    var getTradingPairs = new Method ({
        name: 'getTradingPairs',
        call: 'kanban_getTradingPairs',
        params: 0
    });

    var getTSWalletAddresses = new Method ({
        name: 'getTSWalletAddresses',
        call: 'pbft_getTSWalletAddresses',
        params: 0
    });
    ...
    var getAllActiveOrdersFromDB = new Method ({
        name: 'getAllActiveOrdersFromDB',
        call: 'kanban_getAllActiveOrdersFromDB',
        params: 0
    });

    var getAllTradeHistory = new Method ({
        name: 'getAllTradeHistory',
        call: 'kanban_getAllTradeHistory',
        params: 0
    });

    var getOrderListByCoinPair = new Method ({
        name: 'getOrderListByCoinPair',
        call: 'kanban_getOrderListByCoinPair',
        params: 1
    });
    ...
    return [
        getCrosschainDepositEntry,
        getCrosschainWithdrawalEntry,
        getCrosschainWithdrawInfo,
        getTokenList,
        getTradingPairs,
        getTSWalletAddresses,
        getBalance,
        getStorageAt,
        getCode,
        getBlock,
        ...
        getAllActiveOrdersFromDB,
        getAllTradeHistory,
        getOrderListByCoinPair,
        getTradesByBlock,
        getTransaction,
